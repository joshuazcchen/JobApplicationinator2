...
contextBridge.exposeInMainWorld("electronAPI", {
	...
	saveOutput: (content: string, format: "html" | "txt") => ipcRenderer.invoke("save-output", content, format),
	...
	keywords: {
		...
		create: (name: string, triggers: string[]) => ipcRenderer.invoke("kw:create", name, triggers),
		update: (id: number, name: string, triggers: string[]) => ipcRenderer.invoke("kw:update", id, name, triggers),
	...
	templates: {
		...
		create: (name: string, contentHtml: string) => ipcRenderer.invoke("tpl:create", name, contentHtml),
	...
	applications: {
		...
		updateStatus: (id: number, status: string) => ipcRenderer.invoke("app:updateStatus", id, status),
